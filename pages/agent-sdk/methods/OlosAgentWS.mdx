...
Autenticação do Agente na plataforma Olos no Discador e no Olos Channel.
...
Autenticar o Agente na plataforma Olos no Discador e no Olos Channel para integrações com o identity provider Microsoft Azure Active Directory
...
Autenticar o Agente na plataforma Olos no Discador e no Olos Channel para integrações com o identity provider IBM ISAM.
...
Autenticar o Agente na plataforma Olos já no estado de pausa.
...
Solicitar pausa do Agente coordenada entre todas as campanhas de Voz e Olos Channel.
...
Solicitar logout do Agente coordenado entre todas as campanhas de Voz e Olos Channel
...
Solcita que a chamada de voz atual seja tabulada informando um código de integrador realizando um agendamento.
...
Solcita o retorno de uma gravação em uma chamda de voz
